      ...
      <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
        <q-card class="card-bg text-white no-shadow" bordered>
          <q-card-section class="text-center bg-transparent">
            ...
            <div class="text-subtitle2 q-mt-lg">by Prathamesh Devhare</div>
            <div class="text-h6 q-mt-md">Prathamesh Devhare</div>
          </q-card-section>
          <q-card-section>
            <div class="text-body2 text-justify">
              Prathamesh Devhare, a.k.a. @geekholic, is my name. Since 2022, I
              have felt a draw towards programming, and I have since made it my
              goal to become a proficient and experienced programmer. Since I
              started working at Incentius (where I am currently employed), my
              interest for programming has grown.
            </div>
          </q-card-section>
        </q-card>
      </div>
